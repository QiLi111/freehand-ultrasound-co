...
class SSFrameDataset():  # Subject-Scan frame loader
    ...
    def read_json(jason_filename, num_samples=None):
        with open(jason_filename, 'r', encoding='utf-8') as f:
            ...
            return SSFrameDataset(
                ...
                filename_h5    = os.path.dirname(jason_filename)+'/'+'frames_res4.h5',#obj['filename'],
    ...
    def read_json_revise(jason_filename, num_samples=None):
        with open(jason_filename, 'r', encoding='utf-8') as f:
            obj = json.load(f)
            return SSFrameDataset(
                min_scan_len = obj['min_scan_len'],
    ...
    def read_json_down(jason_filename, num_samples=None):
        with open(jason_filename, 'r', encoding='utf-8') as f:
            obj = json.load(f)
            return SSFrameDataset(
                min_scan_len = obj['min_scan_len'],
