from .base_options_isbi import BaseOptions
...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--Loss_type', type=str, default='Plane_norm',help='MSE_points: MSE loss on points; Plane_norm: MSE loss and Loss over the norm of plane;')
