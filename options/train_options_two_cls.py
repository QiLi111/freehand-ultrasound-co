from .base_options_two_cls import BaseOptions
...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--train_val_folder', type=str,default='test',help='the saved foler when training and testing')
        ...
        self.parser.add_argument('--optimiser_num', type=int, default=2,help='the number of optimiser')
        self.parser.add_argument('--branch_id', type=int, default=40,help='range(0,9), 9 branches; -1; weighted branches; which can have classification output')
        ...
        self.parser.add_argument('--use_bash_shell', type=bool, default=True,
