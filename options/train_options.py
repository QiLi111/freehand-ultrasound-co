...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--retain', type=bool,default=True,help='whether load a pretrained model')
        ...
        self.parser.add_argument('--LEARNING_RATE_cls',type=float,default=1e-4,help='learing rate')
        ...
        self.parser.add_argument('--task_weight', type=int, default=1,help='The weight between main task and classification task')



        #######used in testing##################################################
        self.parser.add_argument('--PAIR_INDEX', type=list, default=[1,2,3,4,7],#8, 17, 12, 18
