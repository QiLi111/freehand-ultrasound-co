from .base_options_baseline import BaseOptions
...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--NUM_SAMPLES', type=int,default=49,help='number of input frames/imgs')
        self.parser.add_argument('--SAMPLE_RANGE', type=int,default=49,help='from which the input frames/imgs are selected from')
        self.parser.add_argument('--NUM_PRED', type=int,default=48,help='to those frames/imgs, transformation matrix are predicted ')
        ...
        self.parser.add_argument('--MIN_SCAN_LEN', type=int, default=50,help='scan length that greater than this value can be used in training and val')
        ...
        self.parser.add_argument('--class_protocol', type=int, default=3,help='the number of classes of protocols')
        self.parser.add_argument('--class_anatomy', type=int, default=38,help='the number of classes of anatomies')
        self.parser.add_argument('--branch_id', type=int, default=-1,help='range(0,9), 9 branches; -1; weighted branches; which can have classification output')
        self.parser.add_argument('--atm_pct', type=int, default=0,help='whether use the classification task for protrocol or anatomy; 0: anatomy; 1: protocol')
        ...
        self.parser.add_argument('--FILENAME_VAL', type=str, default="fold_03.json", help='validation json file')
        self.parser.add_argument('--FILENAME_TEST', type=str, default="fold_04.json", help='test json file')

        self.parser.add_argument('--FILENAME_TRAIN', type=list,
                                 default=["fold_00.json", "fold_01.json", "fold_02.json"],
