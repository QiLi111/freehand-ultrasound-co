from .base_options_test_gradient import BaseOptions
...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--task_weight', type=int, default=1000,help='The weight between main task and classification task')
