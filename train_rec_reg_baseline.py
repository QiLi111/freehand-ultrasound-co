...
from utils_rec_volume_2_baseline import *
...
# load half-converged model
# train_rec_reg_model.load_rec_model1000()

# load pre-trained model
if opt.retain == True:
    opt.retain_epoch = '00001600'
    train_rec_reg_model.load_rec_model1600()
