...
class Visualizer():  # plot scan
    ...
    def plot_scan_and_cal_ave_dist(self, opt_test,tran_val, ax,scan_index, PAIR_INDEX,viridis,idx_color,device):
        if tran_val == 'train':
            ...
            frames, tforms, tforms_inv = self.dset_test[scan_index]
