...
test_folders = 'test_models_5'
fd_name_save = 'common_frame_0_1'
csv_name = 'common_metrics.csv'
...
for sub_fd in folders:
    ...
    for i_m in range(len(models_name)):
        ...
        with open(os.getcwd()+'/'+test_folders+'/'+fd_name_save+'/'+sub_fd[29:] + '__' + str(model_name)+'_common.npy', 'wb') as f:
            np.save(f, metrics)
