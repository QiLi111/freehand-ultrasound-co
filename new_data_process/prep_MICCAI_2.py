...
for i_sub, folder in enumerate(folders_subject):
    ...
    for i_scan, fn in enumerate(fn_mha):
        ...
        if 'L' in name_scan[i_sub][i_scan] and 'Par' in name_scan[i_sub][i_scan]:
            protocol_cls = cls_protocol[0]
        elif 'L' in name_scan[i_sub][i_scan] and 'Ver' in name_scan[i_sub][i_scan]:
            protocol_cls = cls_protocol[1]

        elif 'C' in name_scan[i_sub][i_scan] and 'Par' in name_scan[i_sub][i_scan]:
            protocol_cls = cls_protocol[2]
        elif 'C' in name_scan[i_sub][i_scan] and 'Ver' in name_scan[i_sub][i_scan]:
            protocol_cls = cls_protocol[3]


        elif 'S' in name_scan[i_sub][i_scan] and 'Par' in name_scan[i_sub][i_scan]:
