...
# # train reconstruction network on all data (including train, val, and test),
# # to generate data needed for registartion
# train_rec_reg_model = Train_Rec_Reg_Model(opt = opt,
#                         non_improve_maxmum = 1e10, 
#                         reg_loss_weight = 10000,
#                         val_loss_min = 1e10,
#                         val_dist_min = 1e10,
...
train_rec_reg_model.load_best_rec_model_initial()  #load the best model for initialing training transformation model 
train_rec_reg_model.load_best_reg_model_initial()


# train_rec_reg_model.load_best_rec_model()  #load the best model for initialing training transformation model 
# train_rec_reg_model.load_best_reg_model_initial()
